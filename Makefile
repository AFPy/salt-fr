...
help:
	...
	@echo '   make travis                      travis upload via gh-pages         '
	@echo '                                                                       '
...
rsync_upload: publish
	rsync -e "ssh -p $(SSH_PORT) -o StrictHostKeyChecking=accept-new" -P -rvz --delete $(OUTPUTDIR)/ $(SSH_USER)@$(SSH_HOST):$(SSH_TARGET_DIR) --cvs-exclude
